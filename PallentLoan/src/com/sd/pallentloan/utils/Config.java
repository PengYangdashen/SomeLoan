...
public class Config {
	...
	public static final String REGISTER = "servlet/current/JBDUserAction?function=RegisterNewLLD";
	public static final String SEND_CODE = "servlet/current/JBDUserAction?function=SDSendMsgNewLLD";
