...
import com.sd.pallentloan.utils.TimeTaskScroll;
import com.sd.pallentloan.utils.TimeTaskScrollForHome;
public class HomeFragment extends Fragment {
	...
	private void initView() {
		...
		txt = (TextView)view.findViewById(R.id.credit_txt);
...
//					setDialog("camera", "录制视频时请使用前置摄像头对着本人并说'我叫***,从众粒贷借款**元'！");
					break;
				case "还款":
...
//						}
	...
	private void createData() {
		...
		time.schedule(new TimeTaskScrollForHome(ac, record_list, arrPojos), 20,
				20);
