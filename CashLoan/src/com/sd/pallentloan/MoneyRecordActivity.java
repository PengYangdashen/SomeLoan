...
import com.sd.pallentloan.adapter.MoneyRecordAdapter;
...
import com.sd.pallentloan.pojo.MyDialog;
...
//					cl03_status":1,"jk_date":2,"cl_status":1,"create_date":"2017-02-09 09:57:19","cl02_status":1,"jk_money":3300
					...
					if (array.length()==0) {
						...
						for (int i = 0; i < array.length(); i++) {
							...
							pojo.setTime(TimeUtils.parseDate2(Long.parseLong(time.getString("time"))));
	...
	private void setDialog() {
		new com.sd.pallentloan.utils.AlertDialog(MoneyRecordActivity.this).builder().setMsg("您还没有财富记录")
